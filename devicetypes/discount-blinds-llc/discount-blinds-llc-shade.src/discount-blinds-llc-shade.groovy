 ...
 */
metadata {
    definition (name: "Discount Blinds LLC Shade", namespace: "Discount-Blinds-LLC", author: "Discount Blinds LLC", ocfDeviceType: "oic.d.light") {
        ...
        capability "Switch Level" // Combines Shade and Dimmer until we get a Window Shade Level capability
        ...
        // This device handler is for Discount Blinds LLC window coverings
        // 
    ...
    tiles(scale: 2) {
        multiAttributeTile(name:"windowShade", type: "generic", width: 6, height: 4){
            tileAttribute ("device.0", key: "PRIMARY_CONTROL") {
...
private handleLevelReport(physicalgraph.zwave.Command cmd) {
    def descriptionText = "Discount Blinds LLC Window Shade" //null
    def shadeValue = null
